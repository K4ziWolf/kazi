...
<body>
  <section>
  <div id="container">
    <div class="d-flex flex-column text-white" style="background-color: rgb(61, 61, 61) !important">
    <div class="x-btn" style="background-color: rgb(61, 61, 61) !important" ><button class="xd-btn" v-bind:class="open_menu_button " @click="showMenuScreen" >Pokaż menu</button>

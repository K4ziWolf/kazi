...
#option_holder {
  #option_holder {
  display: grid;
  grid-template-columns: auto 1fr; /* Ustawiamy kolumny: pierwsza automatyczna, druga wypełnia resztę dostępnego miejsca */
  grid-template-rows: auto; /* Tylko jedna wiersz */

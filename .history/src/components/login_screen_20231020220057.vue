<template>
  ...
  <div id="login_holder" class="btn btn-outline-secondary col-md-8" >
      <div class="form-group">
          ...
          <input id="username" class="form-control" type="text" v-model="username" required style="width: 60%; margin: 0 auto max-width: 700px;;" >
      ...
      <div>
        <div class="form-group">
          ...
          <input id="password" class="form-control" type="password" v-model="password" required style="width: 60%; margin: 0 auto;">
        </div>
      </div>
    </div>
      <div class="col-12 ">

<template>
  <section id="my-section" style="background-color: #496886; ;">
    ...
    <div id="login_holder" class="btn btn-outline-secondary col-md-8" style="width: 60%; margin: 0 auto; max-width: 2000px; min-width: 300px; background-color: rgb(154, 141, 141)" >
